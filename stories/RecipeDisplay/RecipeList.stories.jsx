...
export const RecipeList = (args) => {
  ...
  const the_filtered_recipes = [{
    ...
    ingredients: [], internal: '245c', minutes: 12, comments: [], search: ' s '
  }];
  ...
  return (
    <Provider store={recipe_store2}>
      <ServerContextProvider server_variables={server_variables} >
        <RecipeListBoundary filtered_recipes={the_filtered_recipes} 
        is_visible_array={[true, true]}></RecipeListBoundary>
...
export const Error_boundary_RecipeList = (args) => {
  ...
  return (
    <Provider store={recipe_store2}>
      <ServerContextProvider server_variables={server_variables} >
        <RecipeListBoundary is_storybook={'boundary-crash'} 
         filtered_recipes={the_filtered_recipes} 
        is_visible_array={[true, true]}></RecipeListBoundary>
      </ServerContextProvider>
      </Provider>
  )
