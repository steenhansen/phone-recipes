...
const NOP_TYPE_CZECH = { linkUp: (nop) => nop, isActive: (x) => false, isPruned: (y) => false, _from: "common-2-require" };
...
module.exports = {
  ...
  NOP_TYPE_CZECH,
  ONLY_ONE_RECIPE_UNFURLED,
  REMOVE_RECORD_VERSION,
  SELF_COMMENTS_ALLOWED,
  SHORTEST_STRING_LEN,
  VALID_REDUCERS,
  commentIdToRecipeId,
  CookOnOwnPage,
