...
const SPEC_RECIPE_TYPES = {
  _id: 'string', cook: 'string', title: 'string', search: 'string',
  steps: 'string', serves: 'string', time: 'string', meal: 'string', cuisine: 'string', diet: 'string', internal: 'string',
  minutes: 'number', ingredients: 'array', comments: 'array'
};
const SPEC_RECIPE_EMPTIES = {
  _id: 'EMPTY-ERROR', cook: 'EMPTY-ERROR', title: 'EMPTY-ERROR', search: 'EMPTY-ERROR',
  steps: 'IG', serves: 'IG', time: 'IG', meal: 'IG', cuisine: 'IG', diet: 'IG', internal: 'IG',
  minutes: 'IG', ingredients: 'IG', comments: 'IG'
};
...
const SPEC_INGREDIENT_EMPTY = { ingredient: 'EMPTY-ERROR', amount: 'IG' };

const SPEC_ID_INGREDIENT_TYPE = { ingredient: 'string', amount: 'string', _id: "string" };              // NOT USED
const SPEC_ID_INGREDIENT_EMPTY = { ingredient: 'EMPTY-ERROR', amount: 'IG', _id: 'EMPTY-ERROR' };   // NOT USED

module.exports = {
  SPEC_ERROR_ID_TYPE, SPEC_COMMENT_ID_EMPTY,
  SPEC_INGREDIENT_TYPE, SPEC_INGREDIENT_EMPTY,
  SPEC_ID_INGREDIENT_TYPE, SPEC_ID_INGREDIENT_EMPTY,
