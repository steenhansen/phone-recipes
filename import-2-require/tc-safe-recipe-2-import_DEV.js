...
import { SPEC_INGREDIENT_TYPE, SPEC_INGREDIENT_EMPTY, SPEC_RECIPE_TYPES, SPEC_TITLE_TYPES, SPEC_RECIPE_EMPTIES, SPEC_TITLE_EMPTY } from "./tc-types-2-import";
...
function PRE_safeSearch(safe_title, steps, safe_ingredients) {
  ...
  const type_issue_ing = type_czech.checkArray_objType0n(id_less_ingredients, SPEC_INGREDIENT_TYPE); // OR bitch
