...
import { PRE_CookRecipes } from "../type-czech-jsx/tc_CookRecipes";
...
function CookRecipes({ is_visible_array, setVisibleRecipes }) {
  ...
  if (create_recipe && user_on_own_page) {
    ...
    return (
      <>
        <div className="font-semibold text-center text-gray-800 ">Make a New Recipe</div>
    ...
    return (
      <>
        <div className="font-semibold text-center text-gray-800 ">Edit Recipe</div>
  ...
  return (
    <>
      ...
      <RecipeListBoundary
        ...
        user_on_own_page={user_on_own_page}
