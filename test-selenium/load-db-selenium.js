...
module.exports = {testRecipes, testComments, idText,safeInitSelenium, stopDriver, idAlive, makeComment, deleteRecipe,
   changeRecipeTitle, buildRecipe, startDriver, checkDbRecipeCount, checkDbCommentCount, 
   WAIT_LOAD_PAGE, TRY_EN_MASSE, waitForLoad, clickId, textId, waitThenClick, waitThenText };
